...
def create_trader(llm):
    ...
    def trader_node(state, name):
        ...
        # fork(core): the webapp injects the user's real portfolio so the Trader
        # sizes the proposal against existing positions, not in a vacuum. Keep
        # this hunk when rebasing on upstream; it is the fork's only prompt edit.
        ...
        portfolio_grounding = (
            " When a real portfolio is provided, consider existing positions, "
            "sector concentration, and available cash when sizing your recommendation."
            if portfolio_context
            else ""
        )
