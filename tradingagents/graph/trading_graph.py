...
class TradingAgentsGraph:
    ...
    def _get_provider_kwargs(self) -> dict[str, Any]:
        ...
        # fork(core): per-user API key, forwarded so the LLM client uses it
        # instead of reading from the environment. Multi-tenant webapp paths
        # set config["api_key"]. Keep when rebasing on upstream.
